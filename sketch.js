...
function preload(){
fishieImage= loadImage("boy.gif");
 tube1Image= loadImage("tube1.gif");
 tube2Image= loadImage("tube2.gif");
 backgroundImage= loadImage("background.gif");
 restartImage= loadImage("restart.png");
 gameOverImage= loadImage("gameOver.gif");
 cloudsImage= loadImage("cupcake.gif");
}
...
function setup() {
 createCanvas(500,400);
   ...
   fishie= createSprite(100,200,10,10);
